...
var $author$project$Gigasecond$add = function (timestamp) {
	return $elm$time$Time$millisToPosix(
		$elm$core$Basics$round(1e12) + $elm$time$Time$posixToMillis(timestamp));
};
...
var $author$project$Tests$gigasecond = function (date) {
	var _v0 = $rtfeldman$elm_iso8601_date_strings$Iso8601$toTime(date);
	if (_v0.$ === 'Ok') {
		var posix = _v0.a;
		return $rtfeldman$elm_iso8601_date_strings$Iso8601$fromTime(
			$author$project$Gigasecond$add(posix));
	} else {
		return '';
	}
};
				...
				[
					...
					function (_v0) {
						return A2(
							...
							$author$project$Tests$gigasecond('2011-04-25'));
					}),
					...
					A2(
						...
						function (_v1) {
							return A2(
								$elm_explorations$test$Expect$equal,
								'2009-02-19T01:46:40.000Z',
								$author$project$Tests$gigasecond('1977-06-13'));
						})),
					$elm_explorations$test$Test$skip(
					A2(
						$elm_explorations$test$Test$test,
						...
						function (_v2) {
							return A2(
								$elm_explorations$test$Expect$equal,
								'1991-03-27T01:46:40.000Z',
								$author$project$Tests$gigasecond('1959-07-19'));
						})),
					$elm_explorations$test$Test$skip(
					A2(
						$elm_explorations$test$Test$test,
						...
						function (_v3) {
							return A2(
								$elm_explorations$test$Expect$equal,
								'2046-10-02T23:46:40.000Z',
								$author$project$Tests$gigasecond('2015-01-24T22:00:00.000Z'));
						})),
					$elm_explorations$test$Test$skip(
					A2(
						$elm_explorations$test$Test$test,
						...
						function (_v4) {
							return A2(
								$elm_explorations$test$Expect$equal,
								'2046-10-03T01:46:39.000Z',
								$author$project$Tests$gigasecond('2015-01-24T23:59:59.000Z'));
						}))
				]))
		]));
var $author$project$Test$Generated$Main1932583143$main = A2(
	$author$project$Test$Runner$Node$run,
	{
		paths: _List_fromArray(
			['/Users/vincentdupont/Exercism/elm/gigasecond/tests/Tests.elm']),
		processes: 8,
...
_Platform_export({'Test':{'Generated':{'Main1932583143':{'init':$author$project$Test$Generated$Main1932583143$main($elm$json$Json$Decode$int)(0)}}}});}(this));
return this.Elm;
})({});
var pipeFilename = "/tmp/elm_test-99047.sock";
