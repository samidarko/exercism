...
var $author$project$Acronym$abbreviate = function (phrase) {
		...
		$elm$core$String$concat(
			A2(
				...
				$elm$core$String$words(
					A3($elm$core$String$replace, '-', ' ', phrase)))));
};
		...
		[
			...
			function (_v0) {
				return A2(
					...
					'PNG',
					$author$project$Acronym$abbreviate('Portable Network Graphics'));
			}),
			A2(
			$elm_explorations$test$Test$test,
			'lowercase words',
			function (_v1) {
				return A2(
					$elm_explorations$test$Expect$equal,
					'ROR',
					$author$project$Acronym$abbreviate('Ruby on Rails'));
			}),
			A2(
			$elm_explorations$test$Test$test,
			'punctuation',
			function (_v2) {
				return A2(
					$elm_explorations$test$Expect$equal,
					'FIFO',
					$author$project$Acronym$abbreviate('First In, First Out'));
			}),
			A2(
			$elm_explorations$test$Test$test,
			'all caps word',
			function (_v3) {
				return A2(
					$elm_explorations$test$Expect$equal,
					'GIMP',
					$author$project$Acronym$abbreviate('GNU Image Manipulation Program'));
			}),
			A2(
			$elm_explorations$test$Test$test,
			...
			function (_v4) {
				return A2(
					$elm_explorations$test$Expect$equal,
					'CMOS',
					$author$project$Acronym$abbreviate('Complementary metal-oxide semiconductor'));
			})
		]));
var $author$project$Test$Generated$Main2264408772$main = A2(
	$author$project$Test$Runner$Node$run,
	{
		paths: _List_fromArray(
			['/Users/vincentdupont/Exercism/elm/acronym/tests/Tests.elm']),
		processes: 8,
...
_Platform_export({'Test':{'Generated':{'Main2264408772':{'init':$author$project$Test$Generated$Main2264408772$main($elm$json$Json$Decode$int)(0)}}}});}(this));
return this.Elm;
})({});
var pipeFilename = "/tmp/elm_test-43715.sock";
