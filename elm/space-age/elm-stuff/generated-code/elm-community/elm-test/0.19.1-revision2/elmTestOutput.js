...
var $author$project$SpaceAge$Earth = {$: 'Earth'};
var $author$project$SpaceAge$Jupiter = {$: 'Jupiter'};
var $author$project$SpaceAge$Mars = {$: 'Mars'};
var $author$project$SpaceAge$Mercury = {$: 'Mercury'};
var $author$project$SpaceAge$Neptune = {$: 'Neptune'};
var $author$project$SpaceAge$Saturn = {$: 'Saturn'};
var $author$project$SpaceAge$Uranus = {$: 'Uranus'};
var $author$project$SpaceAge$Venus = {$: 'Venus'};
var $author$project$SpaceAge$ageOn = F2(
	function (planet, seconds) {
		var earthOrbitalPeriod = 31557600;
		switch (planet.$) {
			case 'Mercury':
...
var $author$project$Tests$tests = A2(
	...
	_List_fromArray(
		[
			...
			'31.7 Earth years in Earth years',
			function (_v0) {
				return A3(
					$elm_explorations$test$Expect$within,
					$elm_explorations$test$Expect$Absolute(0.01),
					31.69,
					A2($author$project$SpaceAge$ageOn, $author$project$SpaceAge$Earth, 1000000000.0));
			}),
			$elm_explorations$test$Test$skip(
			A2(
				$elm_explorations$test$Test$test,
				'2 Earth years in Earth years',
				function (_v1) {
					return A3(
						$elm_explorations$test$Expect$within,
						$elm_explorations$test$Expect$Absolute(0.01),
						2,
						A2($author$project$SpaceAge$ageOn, $author$project$SpaceAge$Earth, 63115200.0));
				})),
			$elm_explorations$test$Test$skip(
			A2(
				$elm_explorations$test$Test$test,
				'67.6 Earth years in Mercury years',
				function (_v2) {
					return A3(
						$elm_explorations$test$Expect$within,
						$elm_explorations$test$Expect$Absolute(0.01),
						280.88,
						A2($author$project$SpaceAge$ageOn, $author$project$SpaceAge$Mercury, 2134835688.0));
				})),
			$elm_explorations$test$Test$skip(
			A2(
				$elm_explorations$test$Test$test,
				'2 Earth years in Mercury years',
				function (_v3) {
					return A3(
						$elm_explorations$test$Expect$within,
						$elm_explorations$test$Expect$Absolute(0.01),
						8.3,
						A2($author$project$SpaceAge$ageOn, $author$project$SpaceAge$Mercury, 63115200.0));
				})),
			$elm_explorations$test$Test$skip(
			A2(
				$elm_explorations$test$Test$test,
				'6 Earth years in Venus years',
				function (_v4) {
					return A3(
						$elm_explorations$test$Expect$within,
						$elm_explorations$test$Expect$Absolute(0.01),
						9.78,
						A2($author$project$SpaceAge$ageOn, $author$project$SpaceAge$Venus, 189839836.0));
				})),
			$elm_explorations$test$Test$skip(
			A2(
				$elm_explorations$test$Test$test,
				'2 Earth years in Venus years',
				function (_v5) {
					return A3(
						$elm_explorations$test$Expect$within,
						$elm_explorations$test$Expect$Absolute(0.01),
						3.25,
						A2($author$project$SpaceAge$ageOn, $author$project$SpaceAge$Venus, 63115200.0));
				})),
			$elm_explorations$test$Test$skip(
			A2(
				$elm_explorations$test$Test$test,
				'67.6 Earth years in Mars years',
				function (_v6) {
					return A3(
						$elm_explorations$test$Expect$within,
						$elm_explorations$test$Expect$Absolute(0.01),
						35.88,
						A2($author$project$SpaceAge$ageOn, $author$project$SpaceAge$Mars, 2129871239.0));
				})),
			$elm_explorations$test$Test$skip(
			A2(
				$elm_explorations$test$Test$test,
				'2 Earth years in Mars years',
				function (_v7) {
					return A3(
						$elm_explorations$test$Expect$within,
						$elm_explorations$test$Expect$Absolute(0.01),
						1.06,
						A2($author$project$SpaceAge$ageOn, $author$project$SpaceAge$Mars, 63115200.0));
				})),
			$elm_explorations$test$Test$skip(
			A2(
				$elm_explorations$test$Test$test,
				'28.6 Earth years in Jupiter years',
				function (_v8) {
					return A3(
						$elm_explorations$test$Expect$within,
						$elm_explorations$test$Expect$Absolute(0.01),
						2.41,
						A2($author$project$SpaceAge$ageOn, $author$project$SpaceAge$Jupiter, 901876382.0));
				})),
			$elm_explorations$test$Test$skip(
			A2(
				$elm_explorations$test$Test$test,
				'2 Earth years in Jupiter years',
				function (_v9) {
					return A3(
						$elm_explorations$test$Expect$within,
						$elm_explorations$test$Expect$Absolute(0.01),
						0.17,
						A2($author$project$SpaceAge$ageOn, $author$project$SpaceAge$Jupiter, 63115200.0));
				})),
			$elm_explorations$test$Test$skip(
			A2(
				$elm_explorations$test$Test$test,
				'63.5 Earth years in Saturn years',
				function (_v10) {
					return A3(
						$elm_explorations$test$Expect$within,
						$elm_explorations$test$Expect$Absolute(0.01),
						2.15,
						A2($author$project$SpaceAge$ageOn, $author$project$SpaceAge$Saturn, 2000000000.0));
				})),
			$elm_explorations$test$Test$skip(
			A2(
				$elm_explorations$test$Test$test,
				'2 Earth years in saturn years',
				function (_v11) {
					return A3(
						$elm_explorations$test$Expect$within,
						$elm_explorations$test$Expect$Absolute(0.01),
						0.07,
						A2($author$project$SpaceAge$ageOn, $author$project$SpaceAge$Saturn, 63115200.0));
				})),
			$elm_explorations$test$Test$skip(
			A2(
				$elm_explorations$test$Test$test,
				'38.3 Earth years in Uranus years',
				function (_v12) {
					return A3(
						$elm_explorations$test$Expect$within,
						$elm_explorations$test$Expect$Absolute(0.01),
						0.46,
						A2($author$project$SpaceAge$ageOn, $author$project$SpaceAge$Uranus, 1210123456.0));
				})),
			$elm_explorations$test$Test$skip(
			A2(
				$elm_explorations$test$Test$test,
				'2 Earth years in uranus years',
				function (_v13) {
					return A3(
						$elm_explorations$test$Expect$within,
						$elm_explorations$test$Expect$Absolute(0.01),
						0.02,
						A2($author$project$SpaceAge$ageOn, $author$project$SpaceAge$Uranus, 63115200.0));
				})),
			$elm_explorations$test$Test$skip(
			A2(
				$elm_explorations$test$Test$test,
				'57.7 Earth years in Neptune years',
				function (_v14) {
					return A3(
						$elm_explorations$test$Expect$within,
						$elm_explorations$test$Expect$Absolute(0.01),
						0.35,
						A2($author$project$SpaceAge$ageOn, $author$project$SpaceAge$Neptune, 1821023456.0));
				})),
			$elm_explorations$test$Test$skip(
			A2(
				$elm_explorations$test$Test$test,
				'2 Earth years in Neptune years',
				function (_v15) {
					return A3(
						$elm_explorations$test$Expect$within,
						$elm_explorations$test$Expect$Absolute(0.01),
						0.01,
						A2($author$project$SpaceAge$ageOn, $author$project$SpaceAge$Neptune, 63115200.0));
				}))
		]));
var $author$project$Test$Generated$Main3986302331$main = A2(
	$author$project$Test$Runner$Node$run,
	{
		paths: _List_fromArray(
			['/Users/vincentdupont/Exercism/elm/space-age/tests/Tests.elm']),
		processes: 8,
		report: $author$project$Test$Reporter$Reporter$ConsoleReport($author$project$Console$Text$UseColor),
		runs: $elm$core$Maybe$Nothing,
		seed: 271302173662342
	},
...
_Platform_export({'Test':{'Generated':{'Main3986302331':{'init':$author$project$Test$Generated$Main3986302331$main($elm$json$Json$Decode$int)(0)}}}});}(this));
return this.Elm;
})({});
var pipeFilename = "/tmp/elm_test-99473.sock";
